...
/************************************************************************************/
GPIO_tenuErrorStatus GPIO_enuSetAlternateFunction(GPIO_tenu_Ports Cpy_u8Port, GPIO_tenu_Pins Cpy_u8Pin, u8 Cpy_u8AF)
{
	GPIO_tenuErrorStatus LocalErrorStatus = GPIO_enuOK;
			...
			if (Cpy_u8Pin < GPIO_enuPin_8)
			{
				for (LocalIterator=0 ;LocalIterator < 8; LocalIterator++)
				{
					if ( (Cpy_u8Pin >> LocalIterator) & 1)
					{
						...
						{
						case GPIO_enuPort_A:
							LocalBuffer = GPIO[0]->GPIO_AFRL;
							LocalBuffer |= (Cpy_u8AF << (4 * LocalIterator));
							GPIO[0]->GPIO_AFRL = LocalBuffer;
							break;

						case GPIO_enuPort_B:
							LocalBuffer = GPIO[1]->GPIO_AFRL;
							LocalBuffer |= (Cpy_u8AF << (4 * LocalIterator));
							GPIO[1]->GPIO_AFRL = LocalBuffer;
							break;

						case GPIO_enuPort_C:
							LocalBuffer = GPIO[2]->GPIO_AFRL;
							LocalBuffer |= (Cpy_u8AF << (4 * LocalIterator));
							GPIO[2]->GPIO_AFRL = LocalBuffer;
							break;

						case GPIO_enuPort_D:
							LocalBuffer = GPIO[3]->GPIO_AFRL;
							LocalBuffer |= (Cpy_u8AF << (4 * LocalIterator));
							GPIO[3]->GPIO_AFRL = LocalBuffer;
							break;

						case GPIO_enuPort_E:
							LocalBuffer = GPIO[4]->GPIO_AFRL;
							LocalBuffer |= (Cpy_u8AF << (4 * LocalIterator));
							GPIO[4]->GPIO_AFRL = LocalBuffer;
							break;

						case GPIO_enuPort_H:
							LocalBuffer = GPIO[5]->GPIO_AFRL;
							LocalBuffer |= (Cpy_u8AF << (4 * LocalIterator));
							GPIO[5]->GPIO_AFRL = LocalBuffer;
							break;
						}
					}
				}
			...
			else if ((Cpy_u8Pin >= GPIO_enuPin_8) && (Cpy_u8Pin <= GPIO_enuPin_15))
			{
				for (LocalIterator=8 ;LocalIterator < 16; LocalIterator++)
				{
					if ( (Cpy_u8Pin >> LocalIterator) & 1)
					{
						...
						{
						case GPIO_enuPort_A:
							LocalBuffer = GPIO[0]->GPIO_AFRH;
							LocalBuffer |= (Cpy_u8AF << (4 * (LocalIterator-8)));
							GPIO[0]->GPIO_AFRH = LocalBuffer;
							break;

						case GPIO_enuPort_B:
							LocalBuffer = GPIO[1]->GPIO_AFRH;
							LocalBuffer |= (Cpy_u8AF << (4 * (LocalIterator-8)));
							GPIO[1]->GPIO_AFRH = LocalBuffer;
							break;

						case GPIO_enuPort_C:
							LocalBuffer = GPIO[2]->GPIO_AFRH;
							LocalBuffer |= (Cpy_u8AF << (4 * (LocalIterator-8)));
							GPIO[2]->GPIO_AFRH = LocalBuffer;
							break;

						case GPIO_enuPort_D:
							LocalBuffer = GPIO[3]->GPIO_AFRH;
							LocalBuffer |= (Cpy_u8AF << (4 * (LocalIterator-8)));
							GPIO[3]->GPIO_AFRH = LocalBuffer;
							break;

						case GPIO_enuPort_E:
							LocalBuffer = GPIO[4]->GPIO_AFRH;
							LocalBuffer |= (Cpy_u8AF << (4 * (LocalIterator-8)));
							GPIO[4]->GPIO_AFRH = LocalBuffer;
							break;

						case GPIO_enuPort_H:
							LocalBuffer = GPIO[5]->GPIO_AFRH;
							LocalBuffer |= (Cpy_u8AF << (4 * (LocalIterator-8)));
							GPIO[5]->GPIO_AFRH = LocalBuffer;
							break;
						}
					}
				}
